...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_status'])) {
    ...
    $update_sql = "UPDATE reason SET status = '$status' WHERE enrollment_number = '$enrollment_number'";
...
<body>
    <div class="admin-leaves" id="admin-leaves">
        <div class="heading" id="leave-approval">Leaves Accepted</div>
    ...
    <div class="all-leaves-container" id="all-leaves-container">
        <table class="table">
            ...
            <?php
            $sql = "SELECT * FROM reason WHERE status = 'Accepted'";
